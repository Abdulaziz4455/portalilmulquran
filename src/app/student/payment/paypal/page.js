          ...
          const paymentResponse = await fetch(
            "https://api.paypal.com/v1/payments/payment",
            {
              ...
              body: JSON.stringify({
                ...
                redirect_urls: {
                  return_url:
                    "https://www.ilmulquran.com/student/payment/paypal/success", // Replace with your success URL
                  cancel_url:
                    "https://www.ilmulquran.com/student/payment/paypal/cancel", // Replace with your cancel URL
                },
                payer: {
